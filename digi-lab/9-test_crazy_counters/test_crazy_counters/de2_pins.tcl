...
#   set_location_assignment  PIN_P26 -to EXT_CLOCK
   ...
   set_location_assignment PIN_G26  -to dinN ;# KEY0
...
#   set_location_assignment PIN_V2   -to SW[17]  ;# SW[17] on the left side
   ...
   set_location_assignment PIN_AE22  -to LEDG0 ;# LEDG[0] on the right side
   set_location_assignment PIN_AF22  -to LEDG1 ;# LEDG[1]
