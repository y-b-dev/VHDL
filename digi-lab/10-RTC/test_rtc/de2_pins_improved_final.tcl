...
#   set_location_assignment  PIN_P26 -to EXT_CLOCK
   ...
   set_location_assignment PIN_N23  -to set_s  ;# KEY1
   set_location_assignment PIN_P23  -to set_m  ;# KEY2
   set_location_assignment PIN_W26  -to set_h  ;# KEY3

   ;################################
   ;# Slide Switches ('1' when up) #
   ;################################

   set_location_assignment PIN_N25  -to set_rtc   ;# SW[0]
...
#   set_location_assignment PIN_V1   -to SW[16]  ;# SW[16]
   set_location_assignment PIN_V2   -to set_civil  ;# SW[17] on the left side
...
#   set_location_assignment PIN_Y12   -to sec_led ;# LEDG[8] Between 7-Segments
