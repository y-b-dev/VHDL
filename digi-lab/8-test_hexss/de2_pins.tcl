...
#   set_location_assignment PIN_W26  -to KEY3  ;# KEY3
   ...
   set_location_assignment PIN_N25  -to din[0]   ;# SW[0]
   set_location_assignment PIN_N26  -to din[1]   ;# SW[1]
   set_location_assignment PIN_P25  -to din[2]  ;# SW[2]
   set_location_assignment PIN_AE14 -to din[3]   ;# SW[3]
   set_location_assignment PIN_AF14 -to din[4]  ;# SW[4]
   set_location_assignment PIN_AD13 -to din[5]   ;# SW[5]
   set_location_assignment PIN_AC13 -to din[6]   ;# SW[6]
   set_location_assignment PIN_C13  -to din[7]   ;# SW[7]
   set_location_assignment PIN_B13  -to intensity[0]   ;# SW[8]
   set_location_assignment PIN_A13  -to intensity[1]   ;# SW[9]
   set_location_assignment PIN_N1   -to intensity[2]  ;# SW[10]
   set_location_assignment PIN_P1   -to intensity[3]  ;# SW[11]
   set_location_assignment PIN_P2   -to intensity[4]  ;# SW[12]
   set_location_assignment PIN_T7   -to intensity[5]  ;# SW[13]
   set_location_assignment PIN_U3   -to intensity[6]	 ;# SW[14]
   set_location_assignment PIN_U4   -to intensity[7]  ;# SW[15]
